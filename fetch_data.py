...
STRATEGIES = [
    ...
    {'key':'napv2', 'label':'NAPv2', 'capital':250_000, 'col':21, 'sheet':'DAILY P&L', 'color':'#E06F6F', 'visible':True,  'tradetron_id':'7803165', 'share_code':'f10c10c5-3bbf-415f-8aee-a59e56a01856', 'subtitle':'Nifty Apex Predator v2',            'sl':3500},
    {'key':'napv3', 'label':'NAPv3', 'capital':250_000, 'col':24, 'sheet':'DAILY P&L', 'color':'#E0B06F', 'visible':True,  'tradetron_id':'8678425', 'share_code':'98a1a981-2594-415a-9dd8-b39cdfa571e9', 'subtitle':'Nifty Apex Predator v3',            'sl':3500},
    {'key':'sapv2', 'label':'SAPv2', 'capital':250_000, 'col':27, 'sheet':'DAILY P&L', 'color':'#6FE0D4', 'visible':True,  'tradetron_id':'8838677', 'share_code':'e906d9cf-8076-4958-800b-e02a5967ef98', 'subtitle':'Sensex Apex Predator v2',           'sl':3500},
    {'key':'sapv3', 'label':'SAPv3', 'capital':250_000, 'col':30, 'sheet':'DAILY P&L', 'color':'#6F9FE0', 'visible':True,  'tradetron_id':'8680369', 'share_code':'a2a10dfa-3c31-47d9-b720-e183681ebc5f', 'subtitle':'Sensex Apex Predator v3',           'sl':3500},
    ...
    # MCX strategies
    {'key':'ngap', 'label':'NAGAP', 'capital':220_000, 'col':8, 'sheet':'DAILY P&L', 'color':'#6F9FE2', 'visible':True,  'tradetron_id':'7927425', 'share_code':'', 'subtitle':'NG Apex Predator',           'sl':1800},
    {'key':'ngapm', 'label':'NAGAPM', 'capital':50_000, 'col':11, 'sheet':'DAILY P&L', 'color':'#6F9FE9', 'visible':True,  'tradetron_id':'9444470', 'share_code':'', 'subtitle':'NG Apex Predator MINI',           'sl':500},
